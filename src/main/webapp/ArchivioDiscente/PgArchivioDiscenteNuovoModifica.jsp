...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4">Crea Nuovo Discente</h1>
  </div>
</div>
...
<div class="container">
  ...
  <div class="form-row">
    ...
    <label for="cognomeDoc">Cognome</label>
      <input type="text" name="txtCognome" class="form-control" value="<%= valoreDiscente.getCognome()%>" id="cognomeDoc">
    </div>
    <div class="form-group col-md-6">
    <label for="nomeDoc">Nome</label>
      <input type="text" name="txtNome" class="form-control" value="<%= valoreDiscente.getNome()%>" id="nomeDoc">
    </div>
  </div>
...
<div class="container">
	...
	<INPUT type="submit" class="btn btn-danger" name="azioneUtente" value="Annulla">
</div>
